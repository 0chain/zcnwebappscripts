...
echo -e "\n\e[93m===============================================================================================================================================================================
                                                                                  Stake miner using delegate wallet
===============================================================================================================================================================================  \e[39m"
pushd ${PROJECT_ROOT} > /dev/null;
  if [[ -n ${M_ID} ]] ; then
      M_ID=$(jq -r .client_id keys/b0mnode1_keys.json )
  else
    ./bin/zwallet mn-lock --miner_id ${M_ID} --tokens 50000 --wallet delegate_wallet.json --configDir . --config config.yaml --silent
  fi
popd > /dev/null;
